<?php
/**
 * Dataset: Number Signed Editions Added
 *
...
/**
 * Class Number_Signed_Editions
 *
 * @package Book_Database\Analytics
 */
class Number_Signed_Editions extends Dataset {

	/**
	 * Get the number of signed editions that were added
	 *
	 * @return int
	 */
