...
/* harmony import */ var _modules_datepicker__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/datepicker */ "./assets/js/src/admin/modules/datepicker.js");
/* harmony import */ var _modules_delete_objects__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/delete-objects */ "./assets/js/src/admin/modules/delete-objects.js");
/* harmony import */ var _modules_editions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/editions */ "./assets/js/src/admin/modules/editions.js");
/* harmony import */ var _modules_media_upload__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/media-upload */ "./assets/js/src/admin/modules/media-upload.js");
/* harmony import */ var _modules_reading_logs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/reading-logs */ "./assets/js/src/admin/modules/reading-logs.js");
/* harmony import */ var _modules_tags__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/tags */ "./assets/js/src/admin/modules/tags.js");
/* harmony import */ var _modules_taxonomies_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/taxonomies.js */ "./assets/js/src/admin/modules/taxonomies.js");
/**
 * Admin Scripts
 *
...
(function ($) {
  ...
  _modules_datepicker__WEBPACK_IMPORTED_MODULE_3__["BDB_Datepicker"].init();
  _modules_delete_objects__WEBPACK_IMPORTED_MODULE_4__["BDB_Delete_Objects"].init();
  _modules_editions__WEBPACK_IMPORTED_MODULE_5__["BDB_Editions"].init();
  _modules_media_upload__WEBPACK_IMPORTED_MODULE_6__["BDB_Media"].init();
  _modules_reading_logs__WEBPACK_IMPORTED_MODULE_7__["BDB_Reading_Logs"].init();
  _modules_tags__WEBPACK_IMPORTED_MODULE_8__["BDB_Tags"].init();
  _modules_taxonomies_js__WEBPACK_IMPORTED_MODULE_9__["BDB_Book_Taxonomies"].init();
})(jQuery);
...
function dateLocalToUTC(localDate) {
  ...
  var utcDate = moment.utc(newDate).format(formatMySQL); //console.log( 'UTC Date', utcDate );
...
var BDB_Reading_Logs = {
  ...
  updateLog: function updateLog(e) {
    ...
    BDB_Reading_Logs.errorWrap.empty().hide();
    var wrap = button.closest('tr');
    var percentage = wrap.find('.bdb-reading-log-percentage-complete input').val();
