...
/* harmony import */ var _modules_tags__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/tags */ "./assets/js/src/admin/modules/tags.js");
/* harmony import */ var _modules_taxonomies_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/taxonomies.js */ "./assets/js/src/admin/modules/taxonomies.js");
/**
 * Admin Scripts
 *
...
(function ($) {
  ...
  _modules_tags__WEBPACK_IMPORTED_MODULE_9__["BDB_Tags"].init();
  _modules_taxonomies_js__WEBPACK_IMPORTED_MODULE_10__["BDB_Book_Taxonomies"].init();
})(jQuery);
...
var BDB_Analytics = {
  batches: [['number-books-finished', 'number-dnf', 'number-new-books', 'number-rereads', 'number-pages-read', 'reading-track']],
  ...
  getStats: function getStats() {
    var loading = '<div id="circleG"><div id="circleG_1" class="circleG"></div><div id="circleG_2" class="circleG"></div><div id="circleG_3" class="circleG"></div></div>'; // Empty the results and set up spinners.
    ...
    for (var i = 0; i < BDB_Analytics.batches.length; i++) {
      ...
      Object(utils__WEBPACK_IMPORTED_MODULE_1__["apiRequest"])('v1/analytics', args, 'GET').then(function (apiResponse) {}).catch(function (error) {});
    }
  }
};
