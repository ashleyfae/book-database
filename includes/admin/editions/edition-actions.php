...
function editions_table($book)
{
    ...
    require_once BDB_DIR.'includes/admin/editions/views/edition-table.php';
    return;
        ...
        <div class="inside">
            <table class="wp-list-table widefat fixed posts">
                ...
                <?php if (user_can_edit_books()) : ?>
                    ...
                    <tr>
                        <td colspan="6">
                            <button type="button" id="bdb-add-edition" class="button"><?php _e('Add Edition',
                                    'book-database'); ?></button>
                        </td>
                    </tr>
                    </tfoot>
                <?php endif; ?>
            ...
            <?php if (user_can_edit_books()) : ?>
                <div id="bdb-new-edition-fields">
                    ...
                    <div class="bdb-meta-row">
                        <label for="bdb-new-edition-date-acquired"><?php _e('Date Acquired',
                                'book-database'); ?></label>
                        <div class="bdb-meta-value">
                            <input type="text" id="bdb-new-edition-date-acquired" value="<?php echo esc_attr(format_date(current_time('mysql',
                                true), 'Y-m-d')); ?>" class="bdb-datepicker">
                    ...
                    <div class="bdb-meta-row">
                        <button type="button" id="bdb-submit-new-edition" class="button-primary"><?php _e('Add Edition',
                                'book-database'); ?></button>
                    </div>
                </div>
            <?php endif; ?>
