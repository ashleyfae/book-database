 ...
 */
class Series_Table extends BerlinDB\Database\Table {
	...
	/**
	 * If the old `wp_bdb_series_db_version` option exists, copy that value to our new version key.
	 * This will ensure new upgrades are processed on old installs.
	 */
	public function maybe_upgrade() {

		$old_key     = $this->get_db()->prefix . 'bdb_series_db_version';
	 ...
	 *      - Add `unsigned` to `number_books`
	 *
	 * @return bool
	 */
	protected function __201910123() {

		$result = $this->get_db()->query( "ALTER TABLE {$this->table_name} MODIFY number_books bigint(20) UNSIGNED NOT NULL DEFAULT 0" );
