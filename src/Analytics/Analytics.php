...
class Analytics
{
     ...
     * @param  array  $args
     */
    public function __construct(string $start_date, string $end_date, array $args = array())
    {
     ...
     *
     * @see Books_Finished_Count
     * @see Books_DNF_Count
     *
     * @return array
     */
    public function get_number_books_read_breakdown(): array
    {
     ...
     * @return int
     */
    public function get_number_books_finished(): int
    {
     ...
     * @return int
     */
    public function get_number_dnf(): int
    {
        $breakdown = $this->get_number_books_read_breakdown();
     ...
     * @return int
     */
    public function get_number_new_books(): int
    {
        $breakdown = $this->get_number_books_read_breakdown();
     ...
     * @return int
     */
    public function get_number_rereads(): int
    {
        $breakdown = $this->get_number_books_read_breakdown();
     ...
     * @return int
     */
    public function get_number_pages_read(): int
    {
        $query = $this->wpdb->prepare(
     ...
     * @return int|null
     */
    public function get_reading_track(): ?int
    {
        try {
     ...
     * @return object[]
     */
    public function query_reviews(): array
    {
     ...
     * @return int
     */
    public function get_number_reviews(): int
    {
     ...
     * @return int
     */
    public function get_number_different_series(): int
    {
        $query = $this->wpdb->prepare(
     ...
     * @return int
     */
    public function get_number_standalones(): int
    {
        $query = $this->wpdb->prepare(
            "SELECT COUNT(*)
			FROM {$this->tables['reading_log']} AS log 
     ...
     * @return int
     */
    public function get_number_authors(): int
    {
        $query = $this->wpdb->prepare(
     ...
     */
    public function get_rating_breakdown(): array
    {
        $query = $this->wpdb->prepare(
     ...
     * @return array
     */
    public function get_pages_breakdown(int $number_range = 200): array
    {
        $query = $this->wpdb->prepare(
     ...
     */
    public function get_taxonomy_breakdown(string $taxonomy)
    {
        $query = $this->wpdb->prepare(
     ...
     */
    public function get_reviews_written(): ?array
    {
        $reviews = $this->query_reviews();
     ...
     * @return object[]|array|null
     */
    public function get_read_not_reviewed(): ?array
    {
        $query = $this->wpdb->prepare(
