...
namespace Book_Database\ValueObjects;
...
class Rating
{
     ...
     */
    public function set_rating($rating): void
    {
        if (is_null($rating)) {
            $this->rating = null;
     ...
     * @return float|int|null
     */
    public function format(string $format = 'text')
    {
     ...
     * @return string
     */
    public function format_font_awesome(): string
    {
        if (! is_numeric($this->rating)) {
            return $this->format_text();
        }

        $font_awesome_rating = $this->repeat('<i class="fas fa-star"></i>', '<i class="fas fa-star-half-alt"></i>',
     ...
     * @return string
     */
    public function format_html_stars(): string
    {
        if (! is_numeric($this->rating)) {
            return $this->format_text();
        }
     ...
     * @return string
     */
    public function format_html_class(): string
    {
        $class  = '';
        $rating = $this->round_rating();
     ...
     * @return string
     */
    public function repeat(string $full_star, string $half_star = '', string $empty_star = ''): string
    {
        $rating      = $this->round_rating();
