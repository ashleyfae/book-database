...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/js/src/admin/analytics.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./assets/js/src/admin/analytics.js":
/*!******************************************!*\
  !*** ./assets/js/src/admin/analytics.js ***!
  \******************************************/
/*! no exports provided */
...
var BDB_Analytics = {
   ...
   * @param e
   */
  setDateRange: function setDateRange(e) {
    e.preventDefault();
    var args = {
      option: $('#bdb-analytics-date-range-select').val()
    };
    var button = $('#bdb-analytics-set-date-range');
    Object(utils__WEBPACK_IMPORTED_MODULE_1__["spinButton"])(button);
    Object(utils__WEBPACK_IMPORTED_MODULE_1__["apiRequest"])('v1/analytics/range', args, 'POST').then(function (apiResponse) {
      ...
      Object(utils__WEBPACK_IMPORTED_MODULE_1__["unspinButton"])(button);
    });
  },
   ...
   */
  getBlockValues: function getBlockValues() {
    $('.bdb-analytics-block').each(function (blockIndex, block) {
      var blockWrap = $(this);
      var dataset = blockWrap.data('dataset'); // Spinners
      ...
      Object(utils__WEBPACK_IMPORTED_MODULE_1__["apiRequest"])('v1/analytics/dataset/' + dataset, args, 'GET').then(function (apiResponse) {
   ...
   */
  renderDataset: function renderDataset(blockWrap, apiResponse) {
    ...
    switch (apiResponse.type) {
      case 'graph':
        // @todo
        var id = blockWrap.data('canvas');

        if ('undefined' === typeof id || '' === id) {
          return;
        }

        var config = BDB_Analytics.shapeConfig(apiResponse.data);
        new chart_js__WEBPACK_IMPORTED_MODULE_3___default.a(document.getElementById(id).getContext('2d'), config);
        break;
  ...
  shapeConfig: function shapeConfig(config) {
    var letters = '0123456789ABCDEF'.split('');

    if ('pie' === config.type) {
      for (var dataSet = 0; dataSet < config.data.datasets.length; dataSet++) {
        config.data.datasets[dataSet].backgroundColor = [];
        config.data.datasets[dataSet].borderColor = '#ffffff';

        for (var labels = 0; labels < config.data.labels.length; labels++) {
          var colour = '#';
