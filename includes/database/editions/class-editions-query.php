...
/**
 * Class Editions_Query
 * @package Book_Database
 */
class Editions_Query extends BerlinDB\Database\Query {
	 ...
	 * @var string
	 */
	protected $table_schema = '\\Book_Database\\Editions_Schema';
	 ...
	 * @var string
	 */
	protected $item_shape = '\\Book_Database\\Edition';
