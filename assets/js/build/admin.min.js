...
/* harmony import */ var _modules_delete_objects__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/delete-objects */ "./assets/js/src/admin/modules/delete-objects.js");
/* harmony import */ var _modules_editions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/editions */ "./assets/js/src/admin/modules/editions.js");
/* harmony import */ var _modules_media_upload__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/media-upload */ "./assets/js/src/admin/modules/media-upload.js");
/* harmony import */ var _modules_tags__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/tags */ "./assets/js/src/admin/modules/tags.js");
/* harmony import */ var _modules_taxonomies_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/taxonomies.js */ "./assets/js/src/admin/modules/taxonomies.js");
/**
 * Admin Scripts
 *
...
(function ($) {
  ...
  _modules_delete_objects__WEBPACK_IMPORTED_MODULE_3__["BDB_Delete_Objects"].init();
  _modules_editions__WEBPACK_IMPORTED_MODULE_4__["BDB_Editions"].init();
  _modules_media_upload__WEBPACK_IMPORTED_MODULE_5__["BDB_Media"].init();
  _modules_tags__WEBPACK_IMPORTED_MODULE_6__["BDB_Tags"].init();
  _modules_taxonomies_js__WEBPACK_IMPORTED_MODULE_7__["BDB_Book_Taxonomies"].init();
})(jQuery);
...
var BDB_Editions = {
  ...
  addEdition: function addEdition(e) {
    ...
    Object(utils__WEBPACK_IMPORTED_MODULE_0__["apiRequest"])('v1/utility/convert-date', {
      date: args.date_acquired
    }, 'POST').then(function (dateResponse) {
      args.date_acquired = dateResponse;
      console.log(args);
      return Object(utils__WEBPACK_IMPORTED_MODULE_0__["apiRequest"])('v1/edition/add', args, 'POST');
    }).then(function (response) {
      $('#bdb-book-editions-empty').remove();
      BDB_Editions.tableBody.append(BDB_Editions.rowTemplate(response)); // Wipe new field values.
  ...
  updateEdition: function updateEdition(e) {
    ...
    Object(utils__WEBPACK_IMPORTED_MODULE_0__["apiRequest"])('v1/utility/convert-date', {
      ...
      args.date_acquired = dateResponse;
      return Object(utils__WEBPACK_IMPORTED_MODULE_0__["apiRequest"])('v1/edition/update/' + wrap.data('id'), args, 'POST');
