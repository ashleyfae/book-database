...
/* harmony import */ var _modules_tags__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/tags */ "./assets/js/src/admin/modules/tags.js");
/* harmony import */ var _modules_taxonomies_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/taxonomies.js */ "./assets/js/src/admin/modules/taxonomies.js");
/**
 * Admin Scripts
 *
...
(function ($) {
  ...
  _modules_tags__WEBPACK_IMPORTED_MODULE_3__["BDB_Tags"].init();
  _modules_taxonomies_js__WEBPACK_IMPORTED_MODULE_4__["BDB_Book_Taxonomies"].init();
})(jQuery);
...
var BDB_Tags = {
  ...
  init: function init() {
    ...
    $('#book-series-name').suggest(bdbVars.api_base + 'book-database/v1/series/suggest/'); // Save tags on save/publish
